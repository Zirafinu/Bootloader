...
constexpr uint32_t no_request = 0;
} // namespace
...
void skip_reset_request() noexcept { application_skip_request = no_request; }
...
void update_reset_request() noexcept { application_skip_request = no_request; }

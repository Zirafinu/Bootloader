...
set(CPU_GEN_FLAGS "-mcpu=cortex-m4 -mthumb -mabi=aapcs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -fno-exceptions -nostartfiles")
...
# -fno-exceptions           Disable exceptions
# -nostartfiles             Don't link the compilers start files
set(CMAKE_EXE_LINKER_FLAGS_INIT " -Wl,--gc-sections -fno-exceptions -nostartfiles" CACHE INTERNAL "Linker options")

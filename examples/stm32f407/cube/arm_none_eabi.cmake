...
# -nostartfiles             Don't use the default start files
set(OBJECT_GEN_FLAGS "${CPU_GEN_FLAGS} ${WARNING_FLAGS} -fno-builtin -ffunction-sections -fdata-sections -fomit-frame-pointer -nostartfiles")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "${CPU_GEN_FLAGS} -Wl,--gc-sections -nostartfiles -eReset_Handler -Wl,--print-memory-usage" CACHE INTERNAL "Linker options")
